...
const greeting = {
  username: "Jonathan Dang",
  title: "Hi all, I'm Jonathan",
  subTitle: emoji(
    "CS student leveraging data and code to drive informed decisions; open to diverse data and business roles."
  ),
  resumeLink:
...
const socialMediaLinks = {
  ...
  linkedin: "https://www.linkedin.com/in/jonathan-dang9",
  gmail: "jonathandang9191@gmail.com",
...
const workExperiences = {
  ...
  experience: [
    {
      role: "Enforcement Data Operations Intern",
      company: "California Air Resources Board",
      companylogo: require("./assets/images/carb.jpeg"),
      date: "February 2025 – May 2025",
      desc: "An agency of the government of California that aims to reduce air pollution.",
      descBullets: [
